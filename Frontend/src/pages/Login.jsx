        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
            <div className="w-full max-w-[440px] space-y-8">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500 font-medium">Log in to track and report civic issues.</p>
                </div>
                ...
                <p className="text-center text-slate-500 font-medium">
                    New to CivicTrack? <Link to="/register" className="text-emerald-600 font-bold hover:text-emerald-700 transition-colors border-b-2 border-emerald-100 hover:border-emerald-600 pb-0.5">Create Account</Link>
                </p>
            </div>
        </div>
    );
